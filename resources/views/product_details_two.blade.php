            ...
            <div class="container">
                <div class="pg-tp-wrp">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ $products->product_title }}</li>
                    </ol>
                </div><!-- Page Top Wrap -->
            </div>
        </div>
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="position-relative mb-50-r">
                                <a class="img-opacity-hover" href="#">
                                    ...
                                    <img src="{{ asset('admin/upload/post-images/' .$products->product_image)}}" alt="news" class="img-fluid width-100 mb-30">
                                    @else
                                ...
                                <h3 class="title-medium-dark size-c26">
                                    <a href="/blgo/{{ $products->post_title_seo_url }}">{{ $products->post_title }}</a>
                                </h3>
    ...
    <button type="submit" class="input-group-addon btn btn-dark">Submit</button>
                            ...
                            <div class="sidebar-box">
                                ...
                                <div class="position-relative mb30-list bg-body">
                                    ...
                                    <div class="media">
                                        <a class="img-opacity-hover" href="{{ url('/product-details/' . $other_products->id) }}">
                                            @if (isset($other_products->product_image))
                                            <img src="{{ url('admin/upload/post-images/'.$other_products->product_image) }}" alt="news" class="img-fluid" style="width: 124px;height: 108px;object-fit: cover;">
                                            @else
                                 <img id="output_banner" src ="{{ asset('admin/dist/img/No-Image-Basic.png') }}" height="100"/>
@endif
                                        </a>
                                        <div class="media-body hm2-news-block">
                                            ...
                                            <h4 style="color:#000;font-size: 16px;"><a href="{{ url('/product-details/'. $other_products->id) }}" style="color:#000">{{ Str::limit($other_products->product_title, 50) }}
