                      ...
                      <table class="mytabledesing" width="100%">
                        ...
                        <tbody id="Tbodyvariation">
                          <tr id="TRbodyvariation">
                            ...
                            <td>
                              <input type="text" name="category_name[]" class="form-control" placeholder="Enter Category Name" required> </td>
                            ...
                            <td width="200">
                              <input type="file" name="category_image[]" class="form-control"> </td>
