                ...
                <div class="row">
                  <div class="col-1">
                    <div class="d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 50px; height: 50px; text-align: center;">
                      <a href="{{ route('sub_category.create') }}"><i class="fas fa-plus" style="font-size: 30px; color:#fff;"></i></a>
                    </div>
                  </div>
                  <div class="col-10">
                  ...
                  <tbody>
                    ...
                    <td>{{ $loop->index+1 }}</td>
                     ...
                     <td>{{ $sub_category->sub_category_name }}</td>
                      ...
                      <td>
                          <a href="{{ route('sub_category.edit',$sub_category->id) }}" title='Update'><button class='btn btn-xs btn-warning mr-2 p-1'><i class='fas fa-edit' ></i> </button></a>
                              
          <form method="POST" action="{{ route('sub_category.destroy',$sub_category->id) }}" class="d-inline">
            @csrf
            @method('DELETE')
