  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <h5 class="d-flex justify-content-center align-items-center text-center">Update Variation</h5> </div>
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="{{ route('variation.update', $variations->id) }}">
          	@csrf
          @method('put')
                      ...
                      <table class="mytabledesing" width="100%">
                        ...
                        <tbody id="Tbodyvariation">
                          <tr id="TRbodyvariation">
                            ...
                            <td>
                              <input type="text" name="variation_name[]" class="form-control" placeholder="Enter Variation Name" value="{{ old('name',$variations->variation_name)}}" required> </td>
                            
                            <td>
                              <input type="number" name="sort_order[]" class="form-control" placeholder="Sort Order" value="{{ old('name',$variations->sort_order)}}" required> </td>

                            
                            <td>
                              <select class="form-control" name="status[]">
                                  
                                  <option value="enable" {{ ($variations->status == 'enable') ? 'selected' : '' }}>Enable</option>
                                  <option value="disable" {{ ($variations->status == 'disable') ? 'selected' : '' }}>Disable</option>
                                </select>
                            </td>
