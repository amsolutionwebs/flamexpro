                ...
                <div class="card single_courses mt-2 px-1" style="border-top:3px solid tomato;">
                  ...
                  <div class="card-body ">
                    <div class="row">
                      ...
                      <div class="col-11">
                        <h5> Update Pages</h5> </div>
                    </div>
                    <!--  -->
                  </div>
                  <div class="card-body single_courses">
                    <form role="form" method="post" enctype="multipart/form-data" action="{{ route('pages.update', $pages->id) }}">
                    @csrf 
                    @method('put')
                    <div class="row">
                        <!-- registration page -->
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="page_title" id="title" value="{{ old('name',$pages->post_title)}}" required> </div>
                            </div>

                            <div class="col-md-12 mb-2">
                              <label  for="keywords"> Page Content:</label>
                              <textarea class="form-control input-sm" name="page_content" id="summernote" rows="3" required>{{ old('name',$pages->post_content)}}</textarea>
                            </div>
