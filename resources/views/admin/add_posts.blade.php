        ...
        <section class="content">
          <div class="container-fluid">
              ...
              <div class="col-md-12">
                <div class="card single_courses mt-2 px-1" style="border-top:3px solid tomato;">
                  ...
                  <div class="card-body border">
                    <form role="form" method="post" enctype="multipart/form-data" action="/admin/add_posts/store">
                      @csrf
                      <div class="row">
                        <!-- registration page -->
                        <div class="col-md-8">
           ...
           @foreach ($pages as $pages)
                      <option value="{{ $pages->id }}" style="text-transform: uppercase;">{{ $pages->post_title }}</option>
                      @endforeach
                                </select>
                                 </div>
                            </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="post_title" id="title-post" value="" required> </div>
                            </div>

                            <div class="col-md-12 mb-2">
                              <label  for="keywords"> Posts Content:</label>
                              <textarea class="form-control myTextareaaddPost" name="post_content" id="summernote"  rows="7" cols="50" required></textarea>
                            </div>
                            
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="title">Seo Title :</label>
                                <input type="text" name="seo_title" class="form-control" value="" required> </div>
                            </div>
                            
                            <div class="col-md-12">
                              <label  for="keywords"> Meta Description :</label>
                              <textarea class="form-control input-sm" name="meta_description" id="meta_description" rows="3"></textarea>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="meta_keywords" value=""> </div>
                            </div>

                            <div class="col-md-12">
                              <div class="form-group">
              <label for="photo">Posts Image :</label>
        ...
        <img id="output_banner" src ="/admin/dist/img/No-Image-Basic.png" height="100"/>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control input-sm" name="sort_order" id="sort_order" required> </div>
                            </div>
