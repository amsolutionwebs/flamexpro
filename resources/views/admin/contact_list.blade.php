              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered">
                  ...
                  @foreach($contact as $contact)
                      ...
                      <td>
                          <a href='update_contact/{{$contact->id}}/edit' title='Update'><button class='btn btn-xs btn-warning mr-2 p-1'><i class='fas fa-edit' ></i> </button></a>
                            
                          
                          <form method="POST" action="contact/{{ $contact->id }}/destory" class="d-inline">
            @csrf
            @method('DELETE')
