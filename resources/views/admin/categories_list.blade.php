...
@section('master-section')
  ...
  <div class="content-wrapper">
                ...
                <div class="row">
                  <div class="col-1">
                    <div class="d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 50px; height: 50px; text-align: center;">
                      <a href="{{ route('category.create') }}"><i class="fas fa-plus" style="font-size: 30px; color:#fff;"></i></a>
                    </div>
                  </div>
                  <div class="col-10">
    ...
    <img src="/admin/upload/categories-images/{{ $category->category_image }}" title="banner_title" width="50px" height="50">
@else
...
@endif
                      ...
                      <td>
                          <a href="{{ route('category.edit', $category->id) }}" title='Update'><button class='btn btn-xs btn-warning mr-2 p-1'><i class='fas fa-edit' ></i> </button></a>
