  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <h5 class="d-flex justify-content-center align-items-center text-center">Sub Category</h5> </div>
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="{{ route('sub_category.store') }}">
          	@csrf
            ...
            <div class="col-md-12">
             ...
             <div class="col-lg-12 col-sm-12 col-12 mb-4">
                      ...
                      @endforeach
                              ...
                              <td>
                              <input type="text" name="sub_category_name[]" class="form-control" placeholder="Enter Category Name" required> </td>
