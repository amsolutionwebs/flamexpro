  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <a href="/admin/modelnumber" class="mr-2 d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 40px; height: 40px; text-align: center;"> <i class="fa fa-arrow-left" style="font-size: 25px; color:#fff;"></i> </a>
                   </div>
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="{{ route('modelnumber.store') }}">
          	@csrf
          ...
          <div class="row px-2 py-3">
            ...
            <div class="col-md-12">
             ...
             <div class="col-lg-12 col-sm-12 col-12 mb-4">
                      ...
                      <option value="{{ $brand->id }}" style="text-transform: uppercase;">{{ $brand->brand_name }}</option>
                      @endforeach
                            </select>
                               </td>
                                ...
                                <td>
                              <input type="text" name="model_number[]" class="form-control" placeholder="Enter Model Number" required> </td>
