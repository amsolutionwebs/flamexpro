...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light sticky-top">
    ...
    <ul class="navbar-nav">
     ...
     <marquee behavior="alternate" scrollamount="1"><h5 class="font-weight-bold text-dark">FLAMEXPRO</h5></marquee>
    <!-- SEARCH FORM -->
    ...
    align-items: center;">
           ...
           FLAMEXPRO
                 ...
                 <img src="/admin/upload/profile_images/5.jpg" style="width:35px;height: 35px; border-radius:50%; border:2px solid #fff;" />
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <h5 class="ml-4"><i class="fas fa-envelope text-success"></i> PLEASE FILL CAREFULLY DETAILS HERE !</h5></div>
              <form class="form-horizontal" action="/update_password/" method="post" enctype="multipart/form-data">
                <div class="card-body">
          
                  <div class="form-group">
                    <input type="password" name="current_password" class="form-control current_password_p" placeholder="Current Password" >
