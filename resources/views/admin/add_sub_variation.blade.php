  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="{{ route('sub_variation.store') }}">
          	@csrf
          ...
          <div class="row px-2 py-3">
            ...
            <!-- registration page -->
            <div class="col-md-12">
              <h4 style="color:#d9534f;"><b>Sub Variation Details:-</b></h4>
              <hr> </div>
             ...
             <div class="col-lg-12 col-sm-12 col-12 mb-4">
                      ...
                      @endforeach
                              ...
                              <td>
                              <input type="text" name="sub_variation_name[]" class="form-control" placeholder="Enter Sub Variation Name" required> </td>
