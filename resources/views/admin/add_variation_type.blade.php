  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="{{ route('variation_type.store') }}">
          	@csrf
          ...
          <div class="row px-2 py-3">
            ...
            <div class="col-md-12">
             ...
             <div class="col-lg-12 col-sm-12 col-12 mb-4">
                      ...
                      <option value="{{ $variations->id }}" style="text-transform: uppercase;">{{ $variations->variation_name }}</option>
                      @endforeach
                            </select>
                               </td>
                      ...
                      <option value="{{ $sub_variations->id }}" style="text-transform: uppercase;">{{ $sub_variations->sub_variation_name }}</option>
                      @endforeach
                            </select>
                               </td>

                              <td>
                              <input type="text" name="variation_type[]" class="form-control" placeholder="Enter Variation Type" required> </td>
