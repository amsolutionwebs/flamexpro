                ...
                <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-11">
                        <h5> Add New Subcriber</h5> </div>
                    </div>
                    <!--  -->
                  </div>
                  <div class="card-body border">
                    <form role="form" method="post" enctype="multipart/form-data" action="{{ route('subscriber.store') }}">
                    @csrf 
                    <div class="row">
                        <!-- registration page -->
                        <div class="col-md-12">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="email" class="form-control input-sm" name="email"  value="" required> </div>
                            </div>
