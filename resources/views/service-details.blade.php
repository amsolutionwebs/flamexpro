...
></div>
            <div class="container">
                <div class="pg-tp-wrp">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ $service->post_title }}</li>
                    </ol>
                </div><!-- Page Top Wrap -->
            </div>
        </div>
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="position-relative mb-50-r">
                                <a class="img-opacity-hover" href="#">
                                    @if (isset($service->post_image))
                                    <img src="{{ asset('admin/upload/post-images/' .$service->post_image)}}" alt="news" class="img-fluid width-100 mb-30">
                                    @else
                                ...
                                <div class="topic-box-top-lg">
                                    <div class="topic-box-sm color-cod-gray mb-20">service</div>
                                </div>
                               
                                <h3 class="title-medium-dark size-c26">
                                    <a href="/blgo/{{ $service->post_title_seo_url }}">{{ $service->post_title }}</a>
                                </h3>

                                <p style="font-size:20px;">{!! $service->post_content !!}</p>
                        ...
                        <div class="ne-sidebar sidebar-break-md col-lg-4 col-md-12">
                            ...
                            <div class="sidebar-box">
                                <div class="topic-border color-cod-gray mb-30">
                                    <div class="topic-box-lg color-cod-gray">Contact for our services</div>
                                </div>
    ...
    <button type="submit" class="input-group-addon btn btn-dark">Submit</button>
                            ...
                            <div class="sidebar-box">
                                <div class="topic-border color-cod-gray mb-30">
                                    <div class="topic-box-lg color-cod-gray">Other Services</div>
                                </div>

                                @foreach($service_rendom as $service_rendom)
                                <div class="position-relative mb30-list bg-body">
                                    <div class="topic-box-top-xs">
                                        <div class="topic-box-sm color-cod-gray mb-20">Flamexpro</div>
                                    </div>
                                    <div class="media">
                                        <a class="img-opacity-hover" href="{{ url('/blog/' . $service_rendom->post_title_seo_url) }}">
                                            @if (isset($service_rendom->post_image))
                                            <img src="{{ url('admin/upload/post-images/'.$service_rendom->post_image) }}" alt="news" class="img-fluid" style="width: 124px;height: 108px;object-fit: cover;">
                                            @else
                                 <img id="output_banner" src ="{{ asset('admin/dist/img/No-Image-Basic.png') }}" height="100"/>
@endif
                                        </a>
                                        <div class="media-body hm2-news-block">
                                            ...
                                            <h4 style="color:#000;font-size: 16px;"><a href="{{ url('/service/'. $service_rendom->post_title_seo_url) }}" style="color:#000">{{ Str::limit($service_rendom->post_title, 50) }}
